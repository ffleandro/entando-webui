...
const mfApp2 ={
  mfName: "@entando/app2",
  mfURL: "http://localhost:3000/entando-app2.js",
  customProps: {
...
const SpaRemoteParcelExamplePage: NextPage<Props> = () => {
  return (
      <SingleSpaLayout>
        <script type="systemjs-importmap" dangerouslySetInnerHTML={{ __html: importMaps }}>
        </script>
        <script src="https://cdn.jsdelivr.net/npm/systemjs/dist/system.js"></script>
        <script type="systemjs-importmap" dangerouslySetInnerHTML={{ __html: createImportMapFragment({...mfApp2}) }}></script>
        <SSPAWidget {...mfApp2}/>
